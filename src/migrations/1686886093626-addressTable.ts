...
export class addressTable1686886093626 implements MigrationInterface {
    name = 'addressTable1686886093626'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar(60) NOT NULL, "email" varchar(60) NOT NULL, "password" varchar(150) NOT NULL, "cpf" varchar(11) NOT NULL, "phone" varchar(18) NOT NULL, "birthdate" date NOT NULL, "profileImg" varchar(127), "isAdvertiser" boolean NOT NULL DEFAULT (0), "description" text, "createdAt" date NOT NULL DEFAULT (datetime('now')), "updatedAt" date NOT NULL DEFAULT (datetime('now')), "addressId" varchar, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"))`);
        await queryRunner.query(`CREATE TABLE "advertisements" ("id" varchar PRIMARY KEY NOT NULL, "brand" varchar(60) NOT NULL, "model" varchar(120) NOT NULL, "year" integer NOT NULL, "fuel" varchar(20) NOT NULL, "color" varchar(20) NOT NULL, "quilometers" decimal(6,2) NOT NULL DEFAULT (0), "price" decimal(9,2) NOT NULL DEFAULT (0), "coverImage" varchar(150) NOT NULL, "description" text, "isAvailable" boolean NOT NULL DEFAULT (1), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime DEFAULT (datetime('now')), "userId" varchar)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_users" ("id" varchar PRIMARY KEY NOT NULL, "name" varchar(60) NOT NULL, "email" varchar(60) NOT NULL, "password" varchar(150) NOT NULL, "cpf" varchar(11) NOT NULL, "phone" varchar(18) NOT NULL, "birthdate" date NOT NULL, "profileImg" varchar(127), "isAdvertiser" boolean NOT NULL DEFAULT (0), "description" text, "createdAt" date NOT NULL DEFAULT (datetime('now')), "updatedAt" date NOT NULL DEFAULT (datetime('now')), "addressId" varchar, CONSTRAINT "UQ_97672ac88f789774dd47f7c8be3" UNIQUE ("email"), CONSTRAINT "UQ_230b925048540454c8b4c481e1c" UNIQUE ("cpf"), CONSTRAINT "REL_bafb08f60d7857f4670c172a6e" UNIQUE ("addressId"), CONSTRAINT "FK_bafb08f60d7857f4670c172a6ea" FOREIGN KEY ("addressId") REFERENCES "addresses" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_advertisements" ("id" varchar PRIMARY KEY NOT NULL, "brand" varchar(60) NOT NULL, "model" varchar(120) NOT NULL, "year" integer NOT NULL, "fuel" varchar(20) NOT NULL, "color" varchar(20) NOT NULL, "quilometers" decimal(6,2) NOT NULL DEFAULT (0), "price" decimal(9,2) NOT NULL DEFAULT (0), "coverImage" varchar(150) NOT NULL, "description" text, "isAvailable" boolean NOT NULL DEFAULT (1), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime DEFAULT (datetime('now')), "userId" varchar, CONSTRAINT "FK_5b3a17dd0adeba4fbb27d977304" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`);
        await queryRunner.query(`INSERT INTO "temporary_advertisements"("id", "brand", "model", "year", "fuel", "color", "quilometers", "price", "coverImage", "description", "isAvailable", "createdAt", "updatedAt", "userId") SELECT "id", "brand", "model", "year", "fuel", "color", "quilometers", "price", "coverImage", "description", "isAvailable", "createdAt", "updatedAt", "userId" FROM "advertisements"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "advertisements" ("id" varchar PRIMARY KEY NOT NULL, "brand" varchar(60) NOT NULL, "model" varchar(120) NOT NULL, "year" integer NOT NULL, "fuel" varchar(20) NOT NULL, "color" varchar(20) NOT NULL, "quilometers" decimal(6,2) NOT NULL DEFAULT (0), "price" decimal(9,2) NOT NULL DEFAULT (0), "coverImage" varchar(150) NOT NULL, "description" text, "isAvailable" boolean NOT NULL DEFAULT (1), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime DEFAULT (datetime('now')), "userId" varchar)`);
        await queryRunner.query(`INSERT INTO "advertisements"("id", "brand", "model", "year", "fuel", "color", "quilometers", "price", "coverImage", "description", "isAvailable", "createdAt", "updatedAt", "userId") SELECT "id", "brand", "model", "year", "fuel", "color", "quilometers", "price", "coverImage", "description", "isAvailable", "createdAt", "updatedAt", "userId" FROM "temporary_advertisements"`);
